-- V11__restore_missing_sales_payment_tables.sql
...
CREATE INDEX IF NOT EXISTS idx_khata_tenant ON khata_entries(tenant_id);
CREATE INDEX IF NOT EXISTS idx_sales_tenant ON sales(tenant_id);
CREATE INDEX IF NOT EXISTS idx_sales_customer ON sales(tenant_id, customer_id);
CREATE INDEX IF NOT EXISTS idx_sales_invoice ON sales(tenant_id, invoice_number);
...
CREATE INDEX IF NOT EXISTS idx_payment_sale ON payment_transactions(sale_id);
